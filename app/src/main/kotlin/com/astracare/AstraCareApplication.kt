 ...
 *
 * `PushBeneficiariesWorker` takes an injected dependency, which WorkManager's default factory
 ...
 * androidx...PushBeneficiariesWorker" — a message that points at the worker rather than at the
...
class AstraCareApplication : Application(), Configuration.Provider {
    ...
    override fun onCreate() {
        ...
        syncScheduler.ensurePeriodicPush()
    }
}
